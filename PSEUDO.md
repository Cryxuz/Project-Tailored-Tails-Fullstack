...
### Cart remove button removes all items
### singleItem page image size
### Navbar position
### Navbar hamburger menu. (responsiveness not working!)
### All pages responsiveness not working
### Footer
...
### [x] authentication 
### [x] authorization 
### [x] add to cart (need to finish auth first)
### [x] connect to Stripe or PayPal
### [x] uniform imgs
